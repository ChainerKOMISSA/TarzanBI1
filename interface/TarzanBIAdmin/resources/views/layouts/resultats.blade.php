        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Résultats</a></li>
    ...
    <!--<div class="row" style="align-self : center;">
      ...
      <div class="card card-gray" >
        <div class="card-header">
          ...
          <li class="list-group-item">Produit étudié : {{$data->produit}}</li>
          <li class="list-group-item">Localité à étudier : {{$data->ville}}</li>
          </ul>
      </div>
      </div>
    </div>-->
